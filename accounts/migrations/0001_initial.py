# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-03-17 03:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=32, verbose_name='登录的账号')),
                ...
                ('source', models.CharField(max_length=32, verbose_name='登录来源')),
                ('created_time', models.DateTimeField(verbose_name='登录时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=16, verbose_name='收件人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=128, null=True, verbose_name='电子邮箱')),
                ('is_email_valid', models.BooleanField(default=False, verbose_name='电子邮箱是否验证')),
                ('phone_num', models.CharField(blank=True, max_length=20, null=True, verbose_name='电话号码')),
                ('is_phone_valid', models.BooleanField(default=False, verbose_name='电话号码是否验证')),
