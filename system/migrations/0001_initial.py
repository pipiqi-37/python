    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.SmallIntegerField(choices=[(11, '首页')], default=11, verbose_name='展示的位置')),
                ('img', models.ImageField(upload_to='slider', verbose_name='图片')),
                ('reorder', models.SmallIntegerField(default=0, help_text='数字越大越靠前', verbose_name='排序')),
                ('start_time', models.DateTimeField(blank=True, null=True, verbose_name='生效开始时间')),
                ('end_time', models.DateTimeField(blank=True, null=True, verbose_name='生效结束时间')),
                ('target_url', models.CharField(blank=True, max_length=255, null=True, verbose_name='图片跳转链接')),
                ('is_valid', models.BooleanField(default=True, verbose_name='是否删除')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
            ],
